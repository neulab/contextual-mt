...
#SBATCH --gres=gpu:1
#SBATCH --mem=16000
#SBATCH --output=./outputs/iwslt2017/en-de/one_to_two_pretrained_drop01_1
#SBATCH --time=0
...
experiment_name=one_to_two_pretrained_1
...
srun fairseq-train \
    ...
    --source-context-size 0 --target-context-size 1 \
    --source-dropout 0.1 \
    --log-interval 10 \
